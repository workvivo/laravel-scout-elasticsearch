...
return [
    ...
    'wait_prepare_stalled' => '[:searchable] was picked up (:stage) but produced no batch within :elapsed s. The prepare stage may be slow, or the worker crashed/was killed (OOM). It is still queued.',
